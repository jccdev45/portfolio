...
export default function BlogPage() {
  return (
    <div className="">
      ...
      <p className="mt-4 text-lg">
        Browse the list of posts on the left and select whichever one your
        little heart desires. If you'd like to discuss any of the topics I've
        written about, don't hesitate to{" "}
        <Link
          href="/contact"
